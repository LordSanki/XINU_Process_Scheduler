...
struct	pentry	{
  ...
  int quanta;     /* number of quantums assigned to proc in current epoch */
  int eprio;      /* priority of process for current epoch */
  Bool rt;         /* flag to tell if proc is realtime or not*/
